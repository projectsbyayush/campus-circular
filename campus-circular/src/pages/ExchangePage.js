        ...
        <div>
          <div className="card" style={{ padding: "18px", marginBottom: "14px" }}>
            ...
            <div style={{ display: "flex", gap: "14px" }}>
              {resource?.images?.[0] && resource.images[0].trim() !== "" ? <img src={resource.images[0]} alt={resource.name} style={{ width: "110px", height: "110px", borderRadius: "var(--radius-sm)", objectFit: "cover", flexShrink: 0, border: '1px solid var(--border)' }} /> : <div style={{ width: "110px", height: "110px", borderRadius: "var(--radius-sm)", background: getCardVisual(resource).bg, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, border: '1px solid var(--border)' }}><i className={getCardVisual(resource).icon} style={{ fontSize: 32, color: "white" }}></i></div>}
              <div>
